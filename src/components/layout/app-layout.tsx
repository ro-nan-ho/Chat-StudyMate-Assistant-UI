      ...
      <div className="flex min-w-0 flex-1 flex-col">
        <header className="flex h-14 shrink-0 items-center justify-between gap-3 border-b border-border bg-background/70 px-4 backdrop-blur-md md:px-6">
          ...
          <div className="flex shrink-0 items-center gap-2">
            <Link
              href="/documents"
              className="group inline-flex h-9 items-center gap-2 rounded-full border border-border bg-card pl-2.5 pr-3.5 text-[13px] font-medium text-foreground transition-all hover:border-primary/30 hover:bg-primary-soft/50"
            >
              <span className="flex h-6 w-6 items-center justify-center rounded-full bg-muted text-muted-foreground transition-colors group-hover:bg-card group-hover:text-primary">
                <Upload className="h-3.5 w-3.5" strokeWidth={2} />
              </span>
              <span className="hidden whitespace-nowrap sm:inline">Tải tài liệu</span>
            </Link>
            <Link
              href="/"
