...
type DocStatus = "indexed" | "embedding" | "chunking" | "uploading" | "error";
    ...
    <div className="scrollbar-thin h-[calc(100vh-3.5rem)] overflow-y-auto">
      <div className="mx-auto max-w-6xl px-6 py-8">
        ...
        >
          ...
          <button className="mt-5 inline-flex items-center gap-2 rounded-full bg-primary px-5 py-2 text-sm font-medium text-primary-foreground shadow-soft hover:opacity-90">
        ...
        <div className="mt-6 grid grid-cols-2 gap-3 md:grid-cols-4">
          {[
            { label: "Upload", value: "6", icon: UploadCloud, tone: "primary" },
            { label: "Chunking", value: "1", icon: Layers, tone: "accent" },
            { label: "Embedding", value: "1", icon: Loader2, tone: "primary" },
            { label: "Đã index", value: "3", icon: CheckCircle2, tone: "secondary" },
          ].map((s) => (
